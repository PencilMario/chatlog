...
[![Go Report Card](https://goreportcard.com/badge/github.com/PencilMario/chatlog)](https://goreportcard.com/report/github.com/PencilMario/chatlog)
[![GoDoc](https://godoc.org/github.com/PencilMario/chatlog?status.svg)](https://godoc.org/github.com/PencilMario/chatlog)
[![GitHub release](https://img.shields.io/github/release/sjzar/chatlog.svg)](https://github.com/PencilMario/chatlog/releases)
[![GitHub license](https://img.shields.io/github/license/sjzar/chatlog.svg)](https://github.com/PencilMario/chatlog/blob/main/LICENSE)
...
- **无法获取密钥**：查看 [FAQ](https://github.com/PencilMario/chatlog/issues/197)
...
```bash
go install github.com/PencilMario/chatlog@latest
```
...
访问 [Releases](https://github.com/PencilMario/chatlog/releases) 页面下载适合您系统的预编译版本。
...
同时欢迎大家分享使用经验和 prompt！如果您有好的 prompt 示例或使用技巧，请通过 [Discussions](https://github.com/PencilMario/chatlog/discussions) 进行分享，共同进步。
